                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto px-6 pt-4 pb-0 min-h-0 relative">
                            {/* Progressive reveal: the question card (category
                                ...
                                veil (MapTilesVeil) over just the map until tiles
                                + overlay are ready. A v1157 full-body veil was
                                tried but made a slow-overlay type (body-of-water)
                                WORSE — it hid the question card behind a
