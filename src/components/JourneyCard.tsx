    ...
    return (
        ...
        >
            ...
            <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-muted-foreground tabular-nums truncate flex items-center gap-1 mt-0.5">
            ...
            <div className="text-xs text-right shrink-0 tabular-nums">
                <div className="font-bold text-sm">{durationMin} min</div>
