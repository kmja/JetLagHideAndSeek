...
export function SpoofIndicator() {
    ...
    return (
        <button
            ...
            className="fixed z-[1950] right-2 top-[calc(env(safe-area-inset-top)+3.25rem)] flex items-center gap-1.5 rounded-full bg-amber-500 text-black px-3 py-1 text-xs font-poppins font-bold shadow-lg active:scale-95 transition-transform"
