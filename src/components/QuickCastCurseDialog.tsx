                ...
                <AlertDialogContent className="max-w-sm">
                    <div className="flex items-start gap-3">
                        ...
                        <button
                            ...
                            className="shrink-0 inline-flex items-center gap-1 rounded-md px-1.5 py-1 text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-colors"
                        >
                    ...
                    {cost && (
                        <div className="mt-2 rounded-md border border-warning/30 bg-warning/10 px-3 py-2">
                            <div className="text-xs uppercase tracking-[0.14em] font-poppins font-bold text-warning">
                                Casting cost
                            </div>
